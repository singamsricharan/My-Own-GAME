class theifinstructons{
    ...
    display(){
        ...
        text(" 1. Move anywhere using: arrow keys or  w, a, s, d.",windowWidth/7,windowHeight/6)
        ...
        text(" 3. Can change as police.",windowWidth/7,windowHeight/6)
        text(" 4. key Can collect coins or cash in rooms or city.",windowWidth/7,windowHeight/6)
        text(" 5. If you are caught you will be in prison.",windowWidth/7,windowHeight/6)
        text(" 6. Must collect 200 coins and 10 cash in 2 min else your coins will be lost  and you will be in prison",windowWidth/7,windowHeight/6);
